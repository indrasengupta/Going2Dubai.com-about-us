...
<footer class="bg-white dark:bg-gray-900">
    <div class="grid grid-cols-2 gap-8 py-8 px-6 md:grid-cols-4">
        ...
        <div>
            ...
            <ul class="text-gray-500 dark:text-gray-400">
                <li class="mb-4">
                    <a href="#" class="hover:underline">Instargram</a>
                </li>
                <li class="mb-4">
    ...
    <div class="py-6 px-4 bg-gray-100 dark:bg-gray-700 md:flex md:items-center md:justify-between">
        <span class="text-sm text-gray-500 dark:text-gray-300 sm:text-center">© 2022 <a href="https://Going2Dubai.com/">Going2Dubai.com™</a>. All Rights Reserved.
        </span>
